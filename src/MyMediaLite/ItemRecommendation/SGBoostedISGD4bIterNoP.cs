...
namespace MyMediaLite.ItemRecommendation
{
	...
	///   </para>
	/// </remarks>
	public class SGBoostedISGD4bIterNoP : IncrementalItemRecommender, IIterativeModel
	{
		...
		///
		protected double[] predictions, errors, partial_sum, node_err, node_lambda;

		///
		public SGBoostedISGD4bIterNoP ()
		{
			UpdateUsers = true;
			UpdateItems = true;
		...
		protected virtual void InitModel()
		{
			...
			node_lambda = new double[num_nodes];
