...
namespace MyMediaLite.ItemRecommendation
{
	...
	/// 	This version uses online gradient boosting with adaptive shrinkage.
	/// </summary>
	/// <remarks>
	///   <para>
	///     Literature:
	...
	///         Online gradient boosting form incremental recommender systems.
	/// 		Discovery Science 2018.
	/// 		https://link.springer.com/chapter/10.1007/978-3-030-01771-2_14
	///       </description></item>
	///       <item><description>
	///         Alina Beygelzimer, Elad Hazan, Satyen Kale, Haipeng Luo:
	///         Online Gradient Boosting.
	/// 		NIPS 2015.
	/// 		https://papers.nips.cc/paper/5725-online-gradient-boosting
	///       </description></item>
	///     </list>
	///   </para>
	///   <para>
	...
	///   </para>
	/// </remarks>
	public class BoostedISGDBeyShrink : IncrementalItemRecommender, IIterativeModel
	{
		...
		public override string ToString()
		{
			return string.Format(
				...
				"BoostedISGDBeyShrink num_factors={0} regularization={1} learn_rate={2} num_iter={3} incr_iter={4} decay={5} num_nodes={6} boosting_learn_rate={7}",
