...
namespace MyMediaLite.ItemRecommendation
{
	...
	/// 	This version uses online gradient boosting without adaptive shrinkage.
	/// </summary>
	/// <remarks>
	///   <para>
	///     Literature:
	...
	///   </para>
	/// </remarks>
	public class BoostedISGDBey : IncrementalItemRecommender, IIterativeModel
	{
		...
		public override string ToString()
		{
			return string.Format(
				...
				"BoostedISGDBey num_factors={0} regularization={1} learn_rate={2} num_iter={3} incr_iter={4} decay={5} num_nodes={6} boosting_learn_rate={7}",
