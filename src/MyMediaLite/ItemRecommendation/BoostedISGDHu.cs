...
namespace MyMediaLite.ItemRecommendation
{
	...
	/// 	This version uses online gradient boosting as proposed by Hu et al..
	/// </summary>
	/// <remarks>
	///   <para>
	///     Literature:
	...
	/// 		AISTATS 2017.
	/// 		http://proceedings.mlr.press/v54/hu17a.html
	///       </description></item>
	///     </list>
	///   </para>
	///   <para>
	...
	///   </para>
	/// </remarks>
	public class BoostedISGDHu : IncrementalItemRecommender, IIterativeModel
	{
		...
		public override void AddFeedback(System.Collections.Generic.ICollection<Tuple<int, int>> feedback)
		{
			...
			foreach (var entry in feedback)
			{
				...
				for (int i = 0; i < num_nodes; i++)
				{
					...
					recommender_nodes[i].Retrain(new Tuple<int,int>[] {entry}, target + residual);
					residual += target - psum;
					target = target - psum;
				}
			}
		}
